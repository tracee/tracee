...
public class TraceeResponseBodyAdvice implements ResponseBodyAdvice<Object> {

	@Autowired
	private TraceeInterceptor interceptor;

	public TraceeResponseBodyAdvice() {
	}

	TraceeResponseBodyAdvice(TraceeInterceptor interceptor) {
