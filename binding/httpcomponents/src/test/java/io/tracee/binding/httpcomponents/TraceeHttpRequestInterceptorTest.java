...
public class TraceeHttpRequestInterceptorTest {
	...
	public void defaultConstructorUsesDefaultProfile() {
		...
		assertThat((TraceeFilterConfiguration) FieldAccessUtil.getFieldVal(interceptor, "filterConfiguration"), sameInstance(PropertiesBasedTraceeFilterConfiguration.instance().DEFAULT));
	}
	...
	public void constructorStoresProfileNameInternal() {
		...
		assertThat((TraceeFilterConfiguration) FieldAccessUtil.getFieldVal(interceptor, "filterConfiguration"), sameInstance(PropertiesBasedTraceeFilterConfiguration.instance().forProfile("testProf")));
	}
}
