package io.tracee.jaxrs.itest;

import io.tracee.Tracee;
import io.tracee.jaxrs.client.TraceeClientRequestFilter;
import io.tracee.jaxrs.client.TraceeClientResponseFilter;
...
public final class AllFilterIT {
    ...
    public void setUp() throws Exception {
        ...
        final ResourceConfig rc = new ResourceConfig().packages("io.tracee.jaxrs");
