...
docker run -d -p 12900:12900 -link tracee-example-graylog-mongodb-1:mongo -link tracee-example-graylog-elasticsearch-1:elasticsearch -h="tracee-example-graylog-server-1" --name="tracee-example-graylog-server-1" tracee-example-graylog-server
