...
docker run -d -p 8081:8080 -link tracee-example-graylog-server-1:graylog --name=tracee-example-jbossas7-1 tracee-example-jbossas7
docker run -d -p 8080:8080 -link tracee-example-graylog-server-1:graylog -link tracee-example-jbossas7-1:jbossas7 --name=tracee-example-tomcat7-1 tracee-example-tomcat7