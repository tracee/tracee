...
@WebService(serviceName = "TraceeJaxWsTestService", portName = "TraceeJaxWsTestPort",
        ...
        endpointInterface = "de.holisticon.util.tracee.examples.jaxws.service.TraceeJaxWsTestService")
@HandlerChain(file = "handlerChain.xml")
public class TraceeJaxWsTestServiceImpl implements TraceeJaxWsTestService {
